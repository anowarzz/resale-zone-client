...
const AdvertizedProducts = () => {
  ...
  console.log(advertisedProducts);
    ...
    return (
        <div>
            <h3 className='text-4xl text-center font-bold mb-16 mx-auto'>Advertized Products</h3>
           
           <div className='grid grid-cols-1 md-grid-cols-2 lg:grid-cols-3'>
          {
            advertisedProducts.map(adProduct => <AdvertizeCard key={adProduct._id} adProduct={adProduct}/>)
          }
           </div>
        </div>
    );
